...
//import ca.ubc.cs.beta.aeatk.runhistory.*;
...
//
//
//		lsf.copyFileToStateDir(LegacyStateFactory.SCENARIO_FILE, new StringBufferInputStream(scen.toString()));
//
//
//
//		if(pis.get(0).getFeatures().size() > 0)
...
//				features.setCharAt(features.length()-1, '\n');
//			}
//			lsf.copyFileToStateDir(LegacyStateFactory.FEATURE_FILE, new StringBufferInputStream(features.toString()));
//		}
//
...
//		}
//
//		lsf.copyFileToStateDir(LegacyStateFactory.INSTANCE_FILE, new StringBufferInputStream(piTxt.toString()));
