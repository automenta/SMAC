...
/**
 * This class represents an element in the associated {@link ParameterConfigurationSpace} and provides a natural {@link Map} like interface for accessing it's members
...
public class ParameterConfiguration implements Map<String, String>, Serializable {
	...
	private class ParameterConfigurationEntrySet extends AbstractSet<Entry<String, String>>
	{
