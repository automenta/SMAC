...
public class ParamConfigurationTest {
	...
	{
		//URL url = ParameterConfigurationSpace.class.getClassLoader().getResource("test-files/" + f);
		File file = new File("./test-files/" + f); //HACK
	...
	public void testIntegerContinuousParameters() {
		ParameterConfigurationSpace configSpace = getConfigSpaceForFile("paramFiles/integerFormatParam.txt");
	...
	public void testInvalidArgumentParameter() {
		...
		ParameterConfigurationSpace configSpace = getConfigSpaceForFile("paramFiles/invalidDefaultParam.txt");
	...
	public void testForbidden() {
		...
		ParameterConfigurationSpace configSpace = getConfigSpaceForFile("paramFiles/forbiddenExampleParam.txt");
